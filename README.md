...
**Note:** This is the official implementation of the manuscript **"EfficientControllable Diffusion via Dynamic Hybrid Attention and Decoupled KnowledgeDistillation"**, currently submitted to **The Visual Computer**.
